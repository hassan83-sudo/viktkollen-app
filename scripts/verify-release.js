...
export function assertDistContract() {
  ...
  const forbiddenPreloads = ['ReminderCenter', 'LaunchReadinessPanel', 'ManualAcceptanceRunner', 'CloudBackupPanel', 'CoachPlanCenter', 'NutritionCoachCenter', 'DataImportCenter', 'DataExportCenter', 'ReportDrilldown', 'SyncHealthDashboard', 'NotificationCenter', 'InsightsCenter', 'AchievementCenter', 'SocialCenter']
