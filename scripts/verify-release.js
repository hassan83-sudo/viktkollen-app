...
export function assertDistContract() {
  ...
  const forbiddenPreloads = ['ReminderCenter', 'LaunchReadinessPanel', 'CloudBackupPanel', 'DataImportCenter', 'ReportDrilldown', 'SyncHealthDashboard', 'NotificationCenter', 'InsightsCenter']
