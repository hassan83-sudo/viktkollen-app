...
export function assertDistContract() {
  ...
  const forbiddenPreloads = ['ReminderCenter', 'LaunchReadinessPanel', 'ManualAcceptanceRunner', 'CloudBackupPanel', 'CoachPlanCenter', 'NutritionCoachCenter', 'PredictionCenter', 'HealthJourneyCenter', 'healthJourneyBuilder', 'DataImportCenter', 'DataExportCenter', 'ReportDrilldown', 'SyncHealthDashboard', 'NotificationCenter', 'InsightsCenter', 'AchievementCenter', 'SocialCenter']
