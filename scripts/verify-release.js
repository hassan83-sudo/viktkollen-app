...
export function assertDistContract() {
  ...
  const forbiddenPreloads = ['ReminderCenter', 'LaunchReadinessPanel', 'ManualAcceptanceRunner', 'CloudBackupPanel', 'CoachPlanCenter', 'NutritionCoachCenter', 'PredictionCenter', 'DataImportCenter', 'DataExportCenter', 'ReportDrilldown', 'SyncHealthDashboard', 'NotificationCenter', 'InsightsCenter', 'AchievementCenter', 'SocialCenter']
