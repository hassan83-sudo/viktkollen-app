...
function AdaptiveCoachPanel({
  ...
  const data = useMemo(() => ({
    ...
    reminderState,
    weights,
  }), [checkIn, checkIns, goalsHabits, healthSnapshot, meals, nutritionGoals, profile, reminderState, weights])
  const model = useMemo(
  ...
  return (
    <section className="panel health-dashboard-v2 adaptive-coach-panel" id="adaptive-coach" aria-labelledby="adaptive-coach-heading">
      <div className="panel-heading">
        <div>
          <p className="eyebrow">Smart Coach V3</p>
      ...
      <div className="insight-plan">
        ...
        <RecommendationList recommendations={model.recommendations} />
      </div>
