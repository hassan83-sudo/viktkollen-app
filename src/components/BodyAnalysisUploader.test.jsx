...
describe('BodyAnalysisUploader', () => {
  it('renders iPhone-safe file capture fallback for the active body scan step', () => {
    ...
    expect(html).toContain('Öppna scanning för Framifrån')
    expect(html).toContain('Öppna scanning för Från sidan')
    expect(html).toContain('Öppna scanning för Bakifrån')
