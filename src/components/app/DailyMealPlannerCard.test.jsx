...
describe('DailyMealPlannerCard', () => {
  it('renders meals and shopping list without technical placeholders', () => {
    ...
    expect(html).toContain('Dagens plan är genererad men inte sparad.')
    expect(html).toContain('Ingen sparad veckoplan ännu')
    expect(html).toContain('Proteinmål kan räknas när minst en planerad dag är sparad.')
