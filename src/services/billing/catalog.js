...
export const ADMIN_AUDIT_ACTION = Object.freeze({
  COST_THRESHOLD_CHANGED: 'cost.threshold.changed',
  COST_THRESHOLD_CREATED: 'cost.threshold.created',
...
export const COST_THRESHOLD_TARGET_TYPE = 'cost_threshold'
...
/**
 * BILL-5A orchestrator outcomes. Maps existing gate codes; does not replace
 * FEATURE_AVAILABILITY / COST_SAFETY / QUOTA_STATUS.
 */
export const ENFORCEMENT_DECISION = Object.freeze({
  ALLOW: 'ALLOW',
  DENY_AUTH: 'DENY_AUTH',
  DENY_COST_HARD_STOP: 'DENY_COST_HARD_STOP',
  DENY_COST_UNAVAILABLE: 'DENY_COST_UNAVAILABLE',
  DENY_ENTITLEMENT: 'DENY_ENTITLEMENT',
  DENY_FEATURE_DISABLED: 'DENY_FEATURE_DISABLED',
  DENY_FEATURE_MAINTENANCE: 'DENY_FEATURE_MAINTENANCE',
  DENY_INTERNAL: 'DENY_INTERNAL',
  DENY_PROVIDER_MAINTENANCE: 'DENY_PROVIDER_MAINTENANCE',
  DENY_PROVIDER_UNAVAILABLE: 'DENY_PROVIDER_UNAVAILABLE',
  DENY_QUOTA: 'DENY_QUOTA',
...
export const COST_THRESHOLD_SELECTION = Object.freeze({
  NO_APPLICABLE_COST_THRESHOLD: 'NO_APPLICABLE_COST_THRESHOLD',
})
